...
const ui = {
  zh: {
    ...
    aiSetupIntro: "服务器尚未配置 DeepSeek API Key。你也可以在这台设备临时启用 AI；Key 只保存在本机浏览器中，不会写入网站代码。",
  ...
  en: {
    ...
    aiSetupIntro: "The server does not have a DeepSeek API key yet. You can enable AI on this device; the key stays in this browser and is never added to the website code.",
