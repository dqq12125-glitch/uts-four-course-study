...
const ui = {
  zh: {
    ...
    timetableVerification: "已于 2026年8月6日按 Allocate+ 更新：9 个活动已分配，0 个候补；数学 Tut1 09 为周二 13:00；C 编程 Cmp1 04 已换为周五 12:00，CB11.B1.100。3 个未分配项目均为可选 UPs 活动，不计入正式课表。",
    teachingDates: "教学日期",
  ...
  en: {
    ...
    timetableVerification: "Updated from Allocate+ on 6 August 2026: 9 activities are allocated and 0 are pending. Mathematics Tut1 09 is Tuesday 13:00; C Programming Cmp1 04 is now Friday 12:00 in CB11.B1.100. The 3 unallocated items are optional UPs activities and are excluded from the official timetable.",
