import { ApiClientCore } from "@deepstudy/api-client";
import {
...
export {
  ...
  DeepStudyApiError,
  normalizeApiBaseUrl,
} from "@deepstudy/api-client";

export class DeepStudyApi extends ApiClientCore {
  ...
  courses(): Promise<{ courses: Course[] }> {
    return this.request("/api/courses", {}, true, coursesResponseSchema);
  }
